...
import EducationExp from "../client/js/models/EducationExp";
...
const educations: EducationExp[] = [
  EducationExp.buildFromObject({
...
const certificates: EducationExp[] = [
  EducationExp.buildFromObject({
    imageSrc: INSTITUTE_ICON_PATH.SU,
    imageAlt: "Syracuse University",
    institute: "Syracuse University",
  ...
  return (
    <Grid container direction="column">
      ...
      <Grid className={classes.grid}>
        {educations.map((x: EducationExp, i: number) => (
          <EduItem {...x} key={i} />
        ))}
      </Grid>
      <Typography
      ...
      <Grid className={classes.grid}>
        {certificates.map((x: EducationExp, i: number) => (
          <EduItem {...x} key={i} />
        ))}
      </Grid>
    </Grid>
